...
const ModalAddServer = ({ onClose }: ModalAddServerProps) => {
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const nameServer: string = e.currentTarget["server-name"].value as string;
    formData.append("server-picture", fileUpdated!);
    formData.append("server-name", nameServer);
    ...
    <div className="modal-container" onClick={onClose}>
      <div className="modal-content" onClick={handleModalClick}>
        <div className="modal-header">
          <strong>Personnalise ton serveur</strong>
